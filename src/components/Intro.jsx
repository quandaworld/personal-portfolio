    ...
    <div className="flex items-center justify-center flex-col pt-20 mb-20">
      ...
      <div className="max-w-4xl grid grid-cols-1 mt-8 mb-2 md:grid-cols-4 gap-y-5 md:gap-6">
        ...
        <div className="col-span-3 self-center">
          ...
          <p className="text-sm mb-4 font-extralight dark:text-amber-50">I believe that programming can be both <span className='font-bold'>structured</span> and <span className='font-bold text-xs text-red-500'>C</span><span className='font-bold text-xs text-green-500'>R</span><span className='font-bold text-xs text-yellow-500'>E</span><span className='font-bold text-xs text-blue-500'>A</span><span className='font-bold text-xs text-purple-500'>T</span><span className='font-bold text-xs text-cyan-500'>I</span><span className='font-bold text-xs text-amber-600'>V</span><span className='font-bold text-xs text-emerald-500'>E</span>. With a highly detail-oriented and methodical nature, I actively seek solutions that nurture creativity.</p>
